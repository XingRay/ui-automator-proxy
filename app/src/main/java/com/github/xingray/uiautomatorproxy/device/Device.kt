...
//        node.password = nodeInfo.isPassword.trueOrNull()
    ...
    fun writeScreenShot(androidTestHolder: AndroidTestHolder, outputStream: OutputStream, format: String, quality: Int = 100) {
        ...
        Log.d(TAG, "writeScreenShot: bitmap:[${bitmap.width}x${bitmap.height}]")
    ...
    fun writeScreenShot2(androidTestHolder: AndroidTestHolder, outputStream: OutputStream, format: String, quality: Int = 100) {
        ...
        val field = androidTestHolder.uiAutomation.javaClass.getDeclaredField("mUiAutomationConnection")
    }
}