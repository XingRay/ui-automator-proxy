...
call adb uninstall %PACKAGE_NAME%.test

call adb install %OUTPUT_DIR%\%APP_NAME%-debug-%VERSION%.apk
call adb install %OUTPUT_DIR%\%APP_NAME%-debug-androidTest-%VERSION%.apk
